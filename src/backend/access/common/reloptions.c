	...
	{
		{
			...
			"MARS slicing column with parameter(bucket size)",
			RELOPT_KIND_MARS,
			ShareUpdateExclusiveLock
		},
		0,
...
default_reloptions(Datum reloptions, bool validate, relopt_kind kind)
{
	...
	static const relopt_parse_elt tab[] = {
		...
		{SOPT_PARALLEL_WORKERS, RELOPT_TYPE_INT, offsetof(StdRdOptions, parallel_workers)},
...
#ifdef MATRIXDB_VERSION
		/*
		 * Mars related option has private tag and does not store in Relation struct.
		 * This is a wrapper, to validate option.
		 */
		/* Accurate grammar option set */
		, {MX_MARS_GROUP_COLUMN, RELOPT_TYPE_STRING, 0}
		, {MX_MARS_GLOBAL_ORDER_COLUMN, RELOPT_TYPE_STRING, 0}
		, {MX_MARS_GROUP_PARAMETER_COLUMN, RELOPT_TYPE_STRING, 0}
		, {MX_MARS_LOCAL_ORDER_COLUMN, RELOPT_TYPE_STRING, 0}
		/* Simple grammar option set */
		, {MX_MARS_TAG_KEY, RELOPT_TYPE_STRING, 0}
		, {MX_MARS_TIME_KEY, RELOPT_TYPE_STRING, 0}
		, {MX_MARS_TIME_BUCKET, RELOPT_TYPE_STRING, 0}
#endif /* MATRIXDB_VERSION */
	};
