...
FuncDetailCode
mx_oper_select_candidate(int nargs, Oid *input_typeids,
						 FuncCandidateList candidates, Oid *operOid)
{
	return oper_select_candidate(nargs, input_typeids, candidates, operOid);
}
