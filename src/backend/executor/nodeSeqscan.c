...
extern Node		   *mars_seqscan_node;

Node	   *mars_seqscan_node = NULL;
						 ...
						 ParallelContext *pcxt)
{
	...
	node->ss.ss_currentScanDesc =
		table_beginscan_parallel_es(node->ss.ss_currentRelation,
				node->ss.ps.plan->targetlist,
				node->ss.ps.plan->qual,
				pscan);
}
