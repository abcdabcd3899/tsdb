...
static bool
_equalMarsDimensionAttr(const MarsDimensionAttr *a, const MarsDimensionAttr *b)
{
	COMPARE_SCALAR_FIELD(dimensiontype);
	COMPARE_SCALAR_FIELD(attnum);
	COMPARE_SCALAR_FIELD(param);
...
equal(const void *a, const void *b)
{
	...
	switch (nodeTag(a))
	{
		...
		case T_MarsDimensionAttr:
			retval = _equalMarsDimensionAttr(a, b);
			break;
#endif /* MATRIXDB_VERSION */
