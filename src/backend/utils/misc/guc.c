...
static void assign_force_parallel_mode(int new_mode, void *extra);
...
static struct config_bool ConfigureNamesBool[] =
{
	...
	{
		{"enable_parallel_mode", PGC_USERSET, QUERY_TUNING_METHOD,
			gettext_noop("Enable parallel mode in MatrixDB"),
			NULL,
			GUC_EXPLAIN
		},
		&enable_parallel_mode,
		/* MatrixDB enables parallel mode by default */
		true,
		NULL, NULL, NULL
	},
	{
...
static struct config_int ConfigureNamesInt[] =
{
...

	{
		...
		&max_worker_processes,
		64 + MaxPMAuxProc, 1, MAX_BACKENDS,
...
static struct config_enum ConfigureNamesEnum[] =
{
...

	{
		...
		&force_parallel_mode_fake,
		FORCE_PARALLEL_OFF, force_parallel_mode_options,
		NULL, assign_force_parallel_mode, NULL
	},
 ...
 *
 * gp_is_writer should not be synced to child.
 */
static bool
...
static void
assign_force_parallel_mode(int new_mode, void *extra)
{
	if (new_mode && new_mode != FORCE_PARALLEL_OFF)
		elog(WARNING, "force_parallel_mode takes no effects in MatrixDB");
}
