							  ...
							  bool use_damping)
{
	 ...
	 * 
	 * MatrixDB: comment out this code block which are introduced by
	 * GPDB4, it's outdated and incorrect, the selectivity logic for
	 * ANTI JOIN and NOTIN JOIN has been changed in the upstream.
	 */
