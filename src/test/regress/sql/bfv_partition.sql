...
CREATE TABLE z (t bigint, c int) PARTITION BY RANGE (TO_TIMESTAMP(t));
CREATE TABLE z1 PARTITION OF z FOR VALUES FROM('2020-01-01') TO('2020-02-01');
ALTER TABLE z ADD PARTITION START('2021-07-24 00:00:00+08') END('2021-07-24 08:00:00+08');
DROP TABLE z;
