...
-- is 37307536 bytes.
select pg_database_size('template0'::name) between 30000000 and 200000000;
select pg_database_size(1::oid) = pg_database_size('template1'::name);

-- 7457776 bytes, as of this writing
select pg_tablespace_size('pg_global'::name) between 5000000 and 50000000;
select pg_tablespace_size(1664::oid) between 5000000 and 50000000;
...
select pg_relation_size('heapsizetest', 'fsm') between 50000 and 350000; -- 294912
