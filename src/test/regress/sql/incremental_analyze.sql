...
-- end_matchsubs
-- client_min_messages is set to "log" in this test case, so make sure
-- no duration sampling logs are generated in this case.
SET log_transaction_sample_rate TO 0.0;
...
-- Reset the GUC
SET log_transaction_sample_rate TO DEFAULT;
