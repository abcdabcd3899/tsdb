...
-- sequence data types
CREATE SEQUENCE sequence_test5 AS integer CACHE 1;
CREATE SEQUENCE sequence_test6 AS smallint CACHE 1;
CREATE SEQUENCE sequence_test7 AS bigint CACHE 1;
CREATE SEQUENCE sequence_test8 AS integer MAXVALUE 100000 CACHE 1;
CREATE SEQUENCE sequence_test9 AS integer INCREMENT BY -1 CACHE 1;
CREATE SEQUENCE sequence_test10 AS integer MINVALUE -100000 START 1 CACHE 1;
CREATE SEQUENCE sequence_test11 AS smallint CACHE 1;
CREATE SEQUENCE sequence_test12 AS smallint INCREMENT -1 CACHE 1;
CREATE SEQUENCE sequence_test13 AS smallint MINVALUE -32768 CACHE 1;
CREATE SEQUENCE sequence_test14 AS smallint MAXVALUE 32767 INCREMENT -1 CACHE 1;
...
CREATE SEQUENCE sequence_test2 START WITH 32 CACHE 1;
CREATE SEQUENCE sequence_test4 INCREMENT BY -1 CACHE 1;
...
CREATE SEQUENCE sequence_test3 CACHE 1;  -- not read from, to test is_called
