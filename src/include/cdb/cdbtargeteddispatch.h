...
extern void PerformSingleDirectDispatchFashPath(int contentId, const char *query_string);
extern List *SingleDirectDispatchPredictFromParseTree(RawStmt *parsetree_list);
