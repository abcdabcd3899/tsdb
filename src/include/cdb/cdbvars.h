...
/*
 * This parameter indicates whether a qExec need to setup the interconnect
 * related context including listening address etc. It is set to true by
 * default, but some process (eg, background worker) doesn't need it.
 */
extern bool Mx_require_motion;
#endif
...
extern double   gp_motion_cost_startup;
