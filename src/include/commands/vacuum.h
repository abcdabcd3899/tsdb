...
extern int acquire_sample_rows(Relation onerel, int elevel, List *va_cols,
							   HeapTuple *rows, int targrows,
							   double *totalrows, double *totaldeadrows);
extern int acquire_inherited_sample_rows(Relation onerel, int elevel, List *va_cols,
							  HeapTuple *rows, int targrows,
							  double *totalrows, double *totaldeadrows);
