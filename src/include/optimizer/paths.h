...
#ifdef MATRIXDB_VERSION
extern List *mars_build_pathkeys_list(PlannerInfo *root, Index parent_relid,
									  Index relid, Path *subpath,
									  RelOptInfo *rel, ScanDirection scandir,
									  List *dimension_attr, List *local_order_attrs);

extern const mono_proc_info *mx_fetch_monotinic_proc(Oid procOid);
#endif /* MATRIXDB_VERSION */
