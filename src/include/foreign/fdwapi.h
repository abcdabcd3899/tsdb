...
/* Including upstream single node fdw and our MPP-able FDW */
#define ISFDW(r) ((r)->rd_rel->relkind == RELKIND_FOREIGN_TABLE)

/* 
 * MPP-able FDW can load data from each QE, instead upstream FDW only load
 * data into QD
 */
#define ISMPPFDW(r) ((r)->rd_fdwroutine->GetRelationSizeOnSegment != NULL)
...
typedef int (*AcquireSampleRowsFunc) (Relation relation, int elevel, List *va_cols,
