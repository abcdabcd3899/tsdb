...
PG_RMGR(RM_MARS_ID, "MARS", mars_redo, mars_desc, mars_identify, NULL, NULL, NULL)
PG_RMGR(RM_SORTHEAP_ID, "SORTHEAP", sortheap_redo, sortheap_desc, sortheap_identify, NULL, NULL, NULL)
PG_RMGR(RM_SORTHEAP2_ID, "SORTHEAP2", sortheap_redo2, sortheap_desc2, sortheap_identify2, NULL, NULL, NULL)
#endif
