...
typedef enum relopt_kind
{
	...
	RELOPT_KIND_MARS = (1 << 14),

	/* if you add a new kind, make sure you update "last_default" too */
	RELOPT_KIND_LAST_DEFAULT = RELOPT_KIND_MARS,
...
extern relopt_value *get_option_set(relopt_value *options, int num_options, const char *opt_name);
#endif							/* RELOPTIONS_H */
