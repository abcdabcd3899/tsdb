...
typedef struct MotionState
{
	...
	/* parallel mode */
	dsm_segment	*seg;			/* part of parallel context: dsm segment handler */
	dsa_area	*area;			/* part of parallel context: dsm area */
	bool		attached;		/* do the worker attached to a parallel context */
	bool		detached;		/* do the worker detached to a parallel context */
} MotionState;
