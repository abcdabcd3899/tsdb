...
extern bool mx_partition_without_validation;
...
#define SOPT_PARALLEL_WORKERS "parallel_workers"


#ifdef MATRIXDB_VERSION
#define MX_MARS_GROUP_COLUMN			"group_col_"
#define MX_MARS_GROUP_PARAMETER_COLUMN	"group_param_col_"
#define MX_MARS_GLOBAL_ORDER_COLUMN		"global_order_col_"
#define MX_MARS_LOCAL_ORDER_COLUMN		"local_order_col_"

/* Simple Grammar of MARS for above */
#define MX_MARS_TAG_KEY					"tagkey"
#define MX_MARS_TIME_KEY				"timekey"
#define MX_MARS_TIME_BUCKET				"timebucket"
#endif
/*
