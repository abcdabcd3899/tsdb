...
typedef void (*TriggerCleanupCallback) (void *context, bool commit);

typedef struct TriggerCleanupData
{
	TriggerCleanupCallback callback;
	void	*context;
} TriggerCleanupData;
#endif
