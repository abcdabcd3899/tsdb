...
/* 
 * if dir is not exist in scan, we want to return a null table
 * instead throw an exception to user
 */
struct MatrixBypassError {
    bool monitor_dir_not_exist;
    bool monitor_error_happend;
};
