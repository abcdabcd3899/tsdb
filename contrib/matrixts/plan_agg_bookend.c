...
#define ts_extension_schema_name() "public"
 ...
 *
 */
void replace_aggref_in_tlist(MinMaxAggPath *minmaxagg_path)
{
 ...
 */
void ts_preprocess_first_last_aggregates(PlannerInfo *root, List *tlist)
{
