...
extern char *http_response_state_header_name(HttpResponseState *state);
extern int http_response_state_status_code(HttpResponseState *state);
extern char *http_response_state_header_value(HttpResponseState *state);
extern size_t http_response_state_content_length(HttpResponseState *state);
extern char *http_response_state_raw_buffer(HttpResponseState *state);
