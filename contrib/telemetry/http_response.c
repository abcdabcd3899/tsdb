...
char *
http_response_state_header_name(HttpResponseState *state)
{
	return state->cur_header_name;
}
int
...
char *
http_response_state_header_value(HttpResponseState *state)
{
	return state->cur_header_value;
}
size_t
...
char *
http_response_state_raw_buffer(HttpResponseState *state)
{
	return state->raw_buffer;
}
